...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => sprintf( __( 'Read more information about Google Maps API Key at %sthis page%s.', 'us' ), '<a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">', '</a>' ),
			'type' => 'textfield',
